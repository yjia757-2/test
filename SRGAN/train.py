...
if __name__ == '__main__':
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        for data, target in train_bar:
            ...
            writer.add_scalar('Training/g_loss', running_results['g_loss'] / running_results['batch_sizes'])
            writer.add_scalar('Training/d_loss', running_results['d_loss'] / running_results['batch_sizes'])
            writer.add_scalar('Training/d_score', running_results['d_score'] / running_results['batch_sizes'])
            writer.add_scalar('Training/g_score', running_results['g_score'] / running_results['batch_sizes'])
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                writer.add_scalar('Validating/psnr', valing_results['psnr'])
                writer.add_scalar('Validating/ssim', valing_results['ssim'])
